...
from pygame.locals import (
    RLEACCEL, #The optional flags argument can be set to pygame.RLEACCEL to provide better performance on non accelerated displays
    K_UP,
    K_DOWN,
    K_LEFT,
    K_RIGHT,
...
while running:
    ...
    for entity in all_sprites:
        ...
        # It takes a sequence as input, with each of the elements corresponding
        # to the ones of blit(). 
